...
def build_rows() -> list[dict[str, Any]]:
    ...
    for key in keys:
        ...
        rows.append({
            ...
            "Verification": i.get("verification_status") or "UNVERIFIED",
            "Verification Ticket": i.get("verification_ticket_ref") or "",
            "Verification Confidence": i.get("verification_confidence") or 0,
            "Verified Hostname": i.get("verified_hostname") or "",
            "Verified Serial": i.get("verified_serial") or "",
            "Verified Model": i.get("verified_model") or "",
            "Source": i.get("source") or "",
            "Source ID": i.get("source_id") or "",
            "IP": d.get("target_host") or i.get("mgmt_ip") or "",
            ...
            "Health": d.get("session_health") or "UNKNOWN",
            "Health Reason": d.get("health_reason") or "",
            "Prompt Context": d.get("prompt_context") or "UNKNOWN",
            "Mapping": mapping,
